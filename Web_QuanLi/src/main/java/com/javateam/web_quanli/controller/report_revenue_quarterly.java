...
public class report_revenue_quarterly extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        year = request.getParameter("year_quarterly");
...
//            item1.put("type_order", list.get(i).getType_order());
        ...
        item.put("date", "Quarterly " + quarterly);
        item.put("titleDate", "Quarterly :");
        ...
        try {
            ...
            // get report
            JasperCompileManager.compileReportToFile(reportLocation + "/report/test_report_week_month.jrxml", reportLocation + "/report/test_report_week_month.jasper");

            File fis = new File(reportLocation + "/report/test_report_week_month.jasper");
            if (!fis.exists()) {
                JasperCompileManager.compileReportToFile(reportLocation + "/report/test_report_week_month.jrxml", reportLocation + "/report/test_report_week_month.jasper");
            }
            file = new FileInputStream(reportLocation + "/report/test_report_week_month.jasper");
