...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="day" role="tabpanel">
        <form style="margin-top: 50px;" class="form-horizontal" method="POST" action="reportOrder" id="formaddbranch" onsubmit="return submitaddbranch()">
    ...
    <div class="tab-pane" id="week_month" role="tabpanel">
        <form style="margin-top: 50px;" class="form-horizontal" method="POST" action="reportOrderWeekMonth" id="formaddbranch">
            <div class="form-group form-group-lg">
    ...
    <div class="tab-pane" id="quaterly" role="tabpanel">
        <form style="margin-top: 50px;" class="form-horizontal" method="POST" action="reportOrderQuarterly" id="formaddbranch" onsubmit="return submitaddbranch()">
            <div class="form-group form-group-lg">
    ...
    <div class="tab-pane" id="year" role="tabpanel">
        <form style="margin-top: 50px;" class="form-horizontal" method="POST" action="reportOrderYear"  >
            <div class="form-group form-group-lg">
